...
I could sell them, but honestly, only at a fraction of their cost.
...
<div class="row justify-content-center">
    <div class="col-7 mt-3 mt-md-0">
        {% include figure.html path="assets/img/server-old.jpg" title="Last version of the old server" class="img-fluid" %}
    </div>
</div>
<div class="caption">
    The ship of Theseus
...
There are some nice (but hella expensive) server-grade motherboards available out there, especially SuperMicro's (e.g. [x13sae](https://www.supermicro.com/en/products/motherboard/x13sae)), which meet the requirements. That might be what I'm going for.
